...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          "https://job-portal-backend-z1fg.onrender.com/api/v1/job/getmyJobs",
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`https://job-portal-backend-z1fg.onrender.com/api/v1/job/update/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    await axios //jobId accepted as a parameter when we click on job details 
      .delete(`https://job-portal-backend-z1fg.onrender.com/api/v1/job/delete/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
